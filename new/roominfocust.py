...
class room_view:
    def __init__(self,root):
        ...
        regbutton=Button(self.root,text="search",font=("consolas",15,"bold"),command=self.showrm,relief=RAISED,bd=5,fg="gold",bg="blue",activeforeground="white",activebackground="red")
        ...
        # regbutton=Button(self.root,text="Delete",font=("consolas",15,"bold"),command=self.mDelete,relief=RAISED,bd=5,fg="gold",bg="blue",activeforeground="white",activebackground="red")
