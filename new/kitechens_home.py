...
class ksHotelManagementSystem:
    def __init__(self,root):
        ...
        img1=img1.resize((1550,180),Image.ANTIALIAS)
        ...
        cust_btn=Button(btn_frame,text="  logout   ",command=self.logout,width=22,font=("times new roman",15,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
        cust_btn.grid(row=1,column=0,pady=1)


        cust_btn4=Button(btn_frame,text="  Service requests    ",command=self.din,width=22,font=("times new roman",15,"bold"),bg="black",fg="gold",bd=0,cursor="hand1")
        cust_btn4.grid(row=0,column=0)

       
        img3=Image.open("E:\hotel_images\hotel_images\hotel1.png")
        img3=img3.resize((1310,620),Image.ANTIALIAS)
        self.photoimg3=ImageTk.PhotoImage(img3)

        lblimg3=Label(main_frame,image=self.photoimg3,bd=4,relief=RIDGE)
        lblimg3.place(x=225,y=0,width=1310,height=620)
        ...
        lblimg5.place(x=0,y=370,width=230,height=250)
...
if __name__ == "__main__":
    root = Tk()
    obj= ksHotelManagementSystem(root)
    root.mainloop()